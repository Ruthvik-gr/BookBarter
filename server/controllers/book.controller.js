...
export const postBook = async (req, res) => {
    ...
    try {
        ...
        const book = new Book({ title, author, genre, description, imageLink, owner: userId });
        await book.save();
...
export const getBook = async (req, res) => {
    ...
    try {
        ...
        const books = await Book.find(query)
            .select('title author genre description imageLink')
...
export const getUserBooks = async (req, res) => {
    ...
    try {
        ...
        const books = await Book.find(query).select('title author genre description imageLink'); // Add imageLink here
...
export const editBook = async (req, res) => {
    ...
    try {
        ...
        book.imageLink = imageLink !== undefined ? imageLink.trim() : book.imageLink;
...
export const getMatches = async (req, res) => {
    ...
    try {
        ...
        const matches = await Book.aggregate([
            ...
            { $unwind: '$ownerDetails' },
            { $project: { title: 1, author: 1, genre: 1, imageLink: 1, 'ownerDetails.username': 1 } }, // Add imageLink here
            { $limit: 17 }
        ]);
